...
export async function BlogIndexRoute({
  ...
  return (
    <main className="bg-white">
      <header className="relative overflow-hidden bg-[#080d1e] py-[4.625rem] text-white md:py-[4.875rem]">
        <div aria-hidden="true" className="absolute inset-0 bg-[radial-gradient(760px_340px_at_82%_-10%,rgba(31,110,140,.28),transparent_68%),radial-gradient(680px_420px_at_6%_118%,rgba(31,110,140,.14),transparent_70%)]" />
        <div className="container relative">
          ...
          >
            ...
            <span className="text-xs font-semibold uppercase tracking-[0.24em] text-[#feb77d]">
              Blog
            </span>
          </nav>
      ...
      {currentPage === 1 && latestPost ? (
        <section aria-labelledby="latest-post-heading" className="bg-[#f7f4ed] px-4 pt-12 md:px-10 md:pt-14 lg:pt-16">
      ...
      <section className="bg-[#f7f4ed] px-4 pb-[6.5rem] pt-12 md:px-10 md:pt-14 lg:pt-16">
        <div className="mx-auto w-full max-w-7xl">
          {latestPost ? (
            <>
              <div className="mb-[2.125rem] flex flex-wrap items-end justify-between gap-4">
                <h2 className="text-[clamp(1.625rem,2.4vw,2rem)] font-semibold leading-[1.15] text-slate-950">All posts</h2>
            ...
            <p className="py-8 text-center text-slate-600">No posts yet</p>
          )}
        </div>
      </section>
