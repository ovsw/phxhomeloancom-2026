...
const richTextComponents: PortableTextProps["components"] = {
  block: {
  ...
  marks: {
    ...
    buttonLink: ({ children, value }) =>
      value?.href ? (
        <Link
          className="my-2 inline-flex min-h-11 items-center justify-center rounded-lg bg-cyan-800 px-5 py-2.5 font-semibold text-white no-underline hover:bg-cyan-700"
          href={value.href}
          rel={value.openInNewTab ? "noopener noreferrer" : undefined}
          target={value.openInNewTab ? "_blank" : undefined}
        >
  ...
  return (
    ...
    >
      <div className="container">
        ...
        {richText?.length ? (
          <div
            className="mx-auto max-w-4xl text-[1.0625rem] leading-8 text-slate-700 [&_a]:text-cyan-800 [&_a]:underline [&_a]:underline-offset-2 [&_h2]:mt-12 [&_h3]:mt-10 [&_h4]:mt-8 [&_img]:my-8 [&_p]:text-pretty"
