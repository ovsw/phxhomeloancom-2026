...
export default function BlogPagination({ pagination }: { pagination: BlogPaginationData }) {
  ...
  const buttonClass =
    "inline-flex min-h-9 min-w-10 items-center justify-center rounded-control border-[1.5px] border-border bg-card px-4 text-sm font-semibold leading-none text-card-foreground transition-colors motion-fast hover:bg-background";
