        ...
        <div className="grid gap-12 pb-16 sm:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1fr]">
          <section aria-labelledby="footer-brand-heading" className="flex flex-col gap-5">
            ...
            <Link
              ...
              className="w-fit rounded-control bg-white px-[18px] py-3.5 focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-[#feb77d] focus-visible:ring-offset-4 focus-visible:ring-offset-[#0c1329]"
              href="/"
            >
              {model.brand.image ? (
                <Image
